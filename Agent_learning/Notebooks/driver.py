...
# MAGIC             index_name="agentic_catalog.agentic_schema.products_docs_combined",
...
agents.deploy("my_model_name", uc_registered_model_info.version, tags = {"endpointSource": "playground"},scale_to_zero=True)
