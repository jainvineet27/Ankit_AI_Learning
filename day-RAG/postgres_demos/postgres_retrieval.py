...
from postgres_demos.postgres_ingestion import get_embeddings_batch, create_chunks, add_data
...
user_query = "give me top 10 maternity leaves infomration bulletp oints "
